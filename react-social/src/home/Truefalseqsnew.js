...
class Truefalseqsnew extends Component {
    render() {
        return (
...
<div style={{ height:"550px",width:"1400px"}}>
          <iframe style={{height:"670px",width:"1370px"}} src='http://127.0.0.1:7864/'></iframe>
        <p class="getstarted btn-get-started"><a href="http://127.0.0.1:7864/" target="myFrame">Open in Full Screen</a></p>     
           </div> 
