  ...
  <div class="row">
    <div class="col-lg-6 d-flex flex-column justify-content-center">
      ...
      <div data-aos="fade-up" data-aos-delay="600">
          ...
          <ul>
        <a href='/shortqsnew#about' class="getstarted btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
        Read More
      </a></ul>
          ...
          <div class="d-flex flex-column justify-content-center" data-aos="fade-up" >
            <div class="content">
              ...
              <div class="text-center text-lg-start">
                <a href="shortqsnew#gen" class="btn-read-more d-inline-flex align-items-center">
...
<div class="container" data-aos="fade-up">
  <div class="row gx-0">
    ...
    <div class="content">
          ...
          <iframe style={{marginLeft:"160px", height:"550px",width:"900px"}} src='http://127.0.0.1:7860'></iframe>
